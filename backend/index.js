...
app.use((_, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; script-src 'self'  ; object-src 'none';" //Controls which sources are allowed to load content (scripts, styles, etc.).This is the most powerful defense against XSS.
  );
  // "unsafe-inline"; -> can make the site vulnerable by allowing inline scripts
  //  "unsafe-eval"; -> can make the site vulnerable by allowing inline scripts
